...
try:
    ...
    b=sr1(a)
    b.show();
    a=IP(dst="10.0.2.112")/TCP(sport=init_sport, dport=init_dport, flags=0x4, seq=b.ack, ack=b.seq)
    d=sr1(c)
    d.show()
    print "\033[32mok: ", m, "\033[0m\n\n\n"
except:
...
try:
    ...
    b=sr1(a)
    b.show();
    c=IP(dst="10.0.2.112")/TCP(sport=init_sport, dport=init_dport, flags=0x11, seq=b.ack, ack=b.seq)
    d=sr1(c)
    d.show()
    print "\033[32mok: ", m, "\033[0m\n\n\n"
except:
